import {
  ...
  MainSectionLeftTitleFirst,
  MainSectionLeftTitleSecond,
  MainSectionRight,
} from "./Main.styled";
...
export const Main = () => {
  return (
    <>
      <MainSection>
        <MainSectionLeft className="background-svg">
          ...
          <MainSectionLeftText>
            ...
            <MainSectionLeftTitle>
              <MainSectionLeftTitleFirst>We're</MainSectionLeftTitleFirst>
              <MainSectionLeftTitleSecond>
                coming soon
              </MainSectionLeftTitleSecond>
            </MainSectionLeftTitle>
            ...
            <MainSectionLeftInputSection>
              <MainSectionLeftInput></MainSectionLeftInput>
              <MainSectionLeftInputButton>
        ...
        <MainSectionRight>
          <img src={heroDesktopImage} alt="Hero desktop" />
        </MainSectionRight>
      </MainSection>
    </>
  );
