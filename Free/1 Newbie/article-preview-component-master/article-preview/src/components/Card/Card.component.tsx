import {
  ...
  CardSectionLeft,
  CardSectionRight,
  CardSectionRightBottom,
  CardSectionRightBottomLeft,
  CardSectionRightBottomLeftAvatar,
  CardSectionRightBottomLeftPerson,
  CardSectionRightBottomLeftPersonData,
  CardSectionRightBottomLeftPersonName,
      ...
      <CardSection>
        ...
        <CardSectionRight>
          ...
          <CardSectionRightBottom>
            ...
            <CardSectionRightBottomRight>
              <CardSectionRightBottomRightArrow onClick={handleArrowClick}>
              ...
              {showAdditionalInfo && (
                <CardSectionRightBottomRightInfo className="Info">
                  <CardSectionRightBottomRightInfoSingle>
                    SHARE
                  </CardSectionRightBottomRightInfoSingle>
                  <CardSectionRightBottomRightInfoSingle>
