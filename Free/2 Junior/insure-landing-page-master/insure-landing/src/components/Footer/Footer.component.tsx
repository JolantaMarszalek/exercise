import {
  FooterSection,
  FooterSectionBottom,
  FooterSectionBottomAbout,
  FooterSectionBottomAboutSingleBar,
  FooterSectionBottomAboutSingleBarAbout,
  FooterSectionBottomAboutSingleBarSingle,
  FooterSectionTop,
  FooterSectionTopLogo,
  FooterSectionTopSocialMedia,
  FooterSectionTopSocialMediaSingle,
} from "./Footer.styled";
