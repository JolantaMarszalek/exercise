...
import {
  ...
  HeaderSectionAboutButtonOpenMedia,
  HeaderSectionAboutMedia,
  HeaderSectionAboutSingle,
  HeaderSectionAboutSingleMedia,
  HeaderSectionLogo,
  HeaderTopSection,
} from "./Header.styled";
  ...
  return (
    <HeaderSection>
      <HeaderTopSection>
        ...
        {showMenuButton && (
          <HeaderSectionAboutButtonOpenMedia onClick={toggleMenu}>
      ...
      {menuOpen && window.innerWidth < 1024 && (
        <HeaderSectionAboutMedia>
          ...
          <HeaderSectionAboutSingleMedia>Blog</HeaderSectionAboutSingleMedia>
          <HeaderSectionAboutSingleMedia>Account</HeaderSectionAboutSingleMedia>
          <HeaderSectionAboutButtonMedia>
            View plans
          </HeaderSectionAboutButtonMedia>
        </HeaderSectionAboutMedia>
