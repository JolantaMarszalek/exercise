import {
  ...
  FooterSectionBottomTextSectionFirst,
  FooterSectionBottomTextSectionSecond,
  FooterSectionBottomTextSectionThird,
  FooterSectionBottomTextSectionFourth,
  FooterSectionBottomTextSectionFirstImage,
  FooterSectionBottomTextSectionFirstText,
  FooterSectionBottomTextSectionSecondSingleLine,
  FooterSectionBottomTextSectionSecondSingleLineImage,
  FooterSectionBottomTextSectionSecondSingleLineText,
  //   FooterSectionTextSingle,
} from "./Footer.styled";
  ...
  return (
    <FooterSection>
      ...
      <FooterSectionBottomText>
        ...
        <FooterSectionBottomTextSectionThird></FooterSectionBottomTextSectionThird>
        <FooterSectionBottomTextSectionFourth></FooterSectionBottomTextSectionFourth>
      </FooterSectionBottomText>
    </FooterSection>
  );
};
