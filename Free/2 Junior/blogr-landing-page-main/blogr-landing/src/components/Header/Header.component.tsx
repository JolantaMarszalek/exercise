    ...
    return (
      <>
        <HeaderSection>
          ...
          <HeaderSectionMenu>
            <HeaderSectionMenuSingle>Product</HeaderSectionMenuSingle>
            <HeaderSectionMenuSingle>Company</HeaderSectionMenuSingle>
            <HeaderSectionMenuSingle>Connect</HeaderSectionMenuSingle>
          </HeaderSectionMenu>
          <HeaderSectionLogin>
