import {
  TopSectionStyled,
  TopSectionStyledBottom,
  TopSectionStyledBottomLeftSide,
  TopSectionStyledBottomLeftSideDescribe,
  TopSectionStyledBottomLeftSideTitle,
  TopSectionStyledBottomRightSide,
  TopSectionStyledTitle,
...
export const TopSection = () => {
  return (
    <>
      <TopSectionStyled>
        <TopSectionStyledTitle>Designed for the future</TopSectionStyledTitle>
        <TopSectionStyledBottom>
          <TopSectionStyledBottomLeftSide>
            <TopSectionStyledBottomLeftSideTitle>
