import {
  ...
  FooterSectionLogo,
  FooterSectionMenu,
  FooterSectionMenuSingle,
  FooterSectionMenuSingleLine,
  FooterSectionMenuSingleTitle,
} from "./Footer.styled";
  ...
  return (
    <>
      <FooterSection>
        ...
        <FooterSectionMenu>
          <FooterSectionMenuSingle>
            <FooterSectionMenuSingleTitle>Product</FooterSectionMenuSingleTitle>
            <FooterSectionMenuSingleLine>Overview</FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>Pricing</FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>
              Marketplace
            </FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>Features</FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>
              Integrations
            </FooterSectionMenuSingleLine>
          </FooterSectionMenuSingle>
          <FooterSectionMenuSingle>
            <FooterSectionMenuSingleTitle>Company</FooterSectionMenuSingleTitle>
            <FooterSectionMenuSingleLine>About</FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>Team</FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>Blog</FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>Careers</FooterSectionMenuSingleLine>
          </FooterSectionMenuSingle>
          <FooterSectionMenuSingle>
            <FooterSectionMenuSingleTitle>Connect</FooterSectionMenuSingleTitle>
            <FooterSectionMenuSingleLine>Contact</FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>
              Newsletter
            </FooterSectionMenuSingleLine>
            <FooterSectionMenuSingleLine>LinkedIn</FooterSectionMenuSingleLine>
          </FooterSectionMenuSingle>
        </FooterSectionMenu>
      </FooterSection>
    </>
