...
import {
  SectionThirdCardButton,
  SectionThirdCardDescribe,
  SectionThirdCardImage,
  SectionThirdCardTitle,
  SectionThirdSection,
  SectionThirdSingleCard1,
  SectionThirdSingleCard2,
  SectionThirdSingleCard3,
  SectionThirdTopSection,
  SectionThirdTopSectionDescribe,
  SectionThirdTopSectionTitle,
} from "./SectionThird.styled";
      ...
      <>
        ...
        <SectionThirdSection>
          <SectionThirdSingleCard1>
            ...
            <SectionThirdCardTitle>Add to Chrome</SectionThirdCardTitle>
            <SectionThirdCardDescribe>
              Minimum version 62
            </SectionThirdCardDescribe>{" "}
            <SectionThirdCardButton>
              {" "}
              <ButtonBigBlue>Add & Install Extension</ButtonBigBlue>
            </SectionThirdCardButton>
          </SectionThirdSingleCard1>
          <SectionThirdSingleCard2>
            {" "}
            ...
            <SectionThirdCardTitle>Add to Firefox</SectionThirdCardTitle>
            <SectionThirdCardDescribe>
              Minimum version 55
            </SectionThirdCardDescribe>
            <SectionThirdCardButton>
          ...
          <SectionThirdSingleCard3>
            ...
            <SectionThirdCardTitle>Add to Opera</SectionThirdCardTitle>
            <SectionThirdCardDescribe>
              Minimum version 46
            </SectionThirdCardDescribe>{" "}
            <SectionThirdCardButton>
